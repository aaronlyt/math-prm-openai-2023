...
class LLMPredictor:
    def __init__(self):
        # Create an LLM.
        model_path = "../../scripts/tmp/prm_sftgen_1e-5/checkpoint-6370/"
        ...
        self.sampling_params = SamplingParams(temperature=0.0, n=1, max_tokens=1024, stop_token_ids=stop_token_ids, stop=stop_words)
...
if __name__ == "__main__":
    ...
    math_train_path = os.path.join(base_dir, "math_splits", "test.jsonl")
    ...
    ds_repeated = test_examples.flat_map(lambda x: [x] * 1)
    ...
    output_path = os.path.join(base_dir, "sampling_data", "mathte_sftgen1e-5_greedy")
